...
| --- | --- | --- | --- |
| metabase-server | 9001 | Browser access to Redmine by http | Y |
| mysql | 3306 | Accessing MySQL database with TCP | Y |
## Documentation

[Metabase Administrator Guide](https://support.websoft9.com/docs/metabase)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Metabase Enterprise Support](https://apps.websoft9.com/metabase) 
